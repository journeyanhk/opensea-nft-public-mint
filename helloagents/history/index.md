...
| 202609191634 | monitor-phase-a | 功能 | ✅已完成 | [链接](2026-09/202609191634_monitor-phase-a/) |
| 202609192327 | favorites | 功能 | ✅已完成 | [链接](2026-09/202609192327_favorites/) |
...
- [202609191634_monitor-phase-a](2026-09/202609191634_monitor-phase-a/) - M7 阶段 A：OpenSea 日历第二信息源（fail-loud + 金丝雀 + 面板徽标/改期信号）、批量痕迹与自动派生聪明铸造者集合、保守估值护栏与流动性标签
- [202609192327_favorites](2026-09/202609192327_favorites/) - M7/C 收藏：星标 + 信号快照（分析标注）、服务端 `.favorites.json` 与 API、收藏 tab 与已不在板面分区、备注/标签、targets.json/jsonl 导出、筛选持久化到 URL hash